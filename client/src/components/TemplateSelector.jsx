...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      id: "modern",
      name: "Modern",
      preview: "Sleek design with a single image and clean typography",
    },
    {
      id: "minimalimage",
      name: "Minimal Image",
          ...
          {templates.map((template) => (
            ...
            >
              ...
              <div className="space-y-1">
                <h4 className="font-medium text-gry-800">{template.name}</h4>
                <div className="mt-2 p-2 bg-blye-50 rounded text-xs text-gray-500">{template.preview}</div>
              </div>
            </div>
          ))}
        </div>
