...
const txt='Our streamlined process helps you create a professional resume in minutes with intelliginent AI-powered tools and features'
    return (
 ...
 <div className="flex items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
        ...
        <Title title='Build your resume' description={txt} />
